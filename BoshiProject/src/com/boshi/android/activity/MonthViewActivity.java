...
import com.boshi.android.tools.NumberHelper;
...
public class MonthViewActivity extends Activity implements OnTouchListener
{
	...
	// 基本变量
	private Context mContext = MonthViewActivity.this;
	...
	private void populateBottomMenuProperties( )
	{
		...
		personal.setOnClickListener( new OnClickListener( ) {
			...
			public void onClick( View v )
			{
				...
				discount.setBackgroundResource( R.drawable.tab_one_normal );
				entertainment.setBackgroundResource( R.drawable.tab_one_normal );
				Intent intent = new Intent(MonthViewActivity.this,MyInfoActivity.class);
		...
		friend.setOnClickListener( new OnClickListener( ) {
			...
			public void onClick( View v )
			{
				...
				discount.setBackgroundResource( R.drawable.tab_one_normal );
				entertainment.setBackgroundResource( R.drawable.tab_one_normal );
				Intent intent = new Intent(MonthViewActivity.this,FriendTabActivity.class);
				startActivity(intent);
			}
		} );
...
//		more.setLayoutParams( params );
	...
	{
		View calendarView = generateContentView( );
		...
		( (LinearLayout) findViewById( R.id.monthviewcalendar ) ).addView( calendarView );
	...
	private View generateContentView( )
	{
		...
		RelativeLayout.LayoutParams params_title = new RelativeLayout.LayoutParams( LayoutParams.FILL_PARENT,
		...
		RelativeLayout.LayoutParams params_br = new RelativeLayout.LayoutParams( LayoutParams.FILL_PARENT,
				1 );
	...
	private LinearLayout createLayout( int iOrientation )
	{
		...
		LayoutParams params = new LayoutParams( android.view.ViewGroup.LayoutParams.FILL_PARENT,// *fill_parent，填满父控件的空白
